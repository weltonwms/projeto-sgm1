...
<form method="post" id="form_usuario" class="form-horizontal">
    <input type="hidden" name="id_usuario" value="<?php echo $usuario->get_id();?>"/>
        ...
        <fieldset>
            <legend>Usuario</legend>
				...
				<label class="control-label col-md-4" for="servico">Login</label> 
                                <div class="col-md-8">
                                    <input name="login"
                                           value="<?php echo $usuario->get_login()?>"
			...
			<div class="form-group">
				<label class="control-label col-md-4">Perfil</label> 
					...
					<option value='0'
                                                <?php if($usuario->get_adm()==0) echo "selected='selected'"?>>
                                                Cliente</option>
					<option value='1' 
                                                <?php if($usuario->get_adm()==1) echo "selected='selected'"?>>
			...
			<div class="form-group" id='div_cliente'>
					...
					<option value=''>--Selecione--</option>
                                        ...
                                        <?php
                                            foreach($clientes as $cliente):
                                                ...
                                                if($cliente->get_id()==$usuario->get_id_cliente()) echo "selected='selected'";
                                                echo ">";
				...
				<button formaction="<?php echo base_url('usuario/gravar_alteracao')?>"
